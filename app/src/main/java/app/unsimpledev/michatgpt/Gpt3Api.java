...
public class Gpt3Api {
    private static final String TAG = Gpt3Api.class.getSimpleName();
    ...
    public void generateText(String prompt, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, BASE_URL, jsonBody, response -> {
                try {
                    ...
                    Log.d(TAG, "=========================");
                    Log.d(TAG, "Error parseando respuesta", e);
                    Log.d(TAG, "=========================");
            ...
            Log.d(TAG, "=========================");
            Log.d(TAG, "Error creando request body", e);
            Log.d(TAG, "=========================");
